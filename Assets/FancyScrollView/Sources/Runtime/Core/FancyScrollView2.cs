...
namespace FancyScrollView
{
    ...
    public abstract class FancyScrollView2<TItemData, TContext> : MonoBehaviour where TContext : class, new()
    {
        /// <summary>
        /// セル同士の間隔.
        /// </summary>
    ...
    public abstract class FancyScrollView2<TItemData> : FancyScrollView<TItemData, NullContext> { }
}
